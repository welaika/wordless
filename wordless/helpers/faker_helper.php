...
class FakerHelper {
   ...
   * @param array $options
   *   An option array to be passed to the PHP Class handling the placeholder
   *   service. See the placeholder service docs for details.
   * 
   * @return @e string
   ...
   * @param array $options
   *   An array of options to manage text generation. Options available are:
